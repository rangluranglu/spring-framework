...
import org.springframework.lang.Nullable;
 ...
 // BeanFactory 采用延迟加载的形式注入bean，即只有在使用到某个Bean时(调用getBean())，才对该Bean进行加载实例化。
 ...
 *
 * <li>从父上下文继承。后代上下文中的定义将始终具有优先权。这意味着，
 * 例如，整个 Web 应用程序可以使用单个父上下文，而每个 servlet 都有自己的子上下文，
 * 该子上下文独立于任何其他 servlet。
 * </ul>
 *
